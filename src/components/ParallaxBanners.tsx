...
const ParallaxBanners = () => {
  ...
  return (
    <section ref={containerRef} className="bg-zinc-50 py-12 relative z-10 promo-container">
      <div className="absolute inset-0 bg-linear-to-b from-zinc-100 via-zinc-50 to-white pointer-events-none z-0" />
        ...
        {PROMO_BANNERS.slice(0, 4).map((banner, i) => (
          ...
          >
            <a href={banner.link} target="_blank" rel="noreferrer"
              ...
              <div className="absolute inset-0 bg-linear-to-br from-indigo-600/10 to-purple-600/10 opacity-0 group-hover:opacity-100 transition-opacity z-10 mix-blend-overlay" />
